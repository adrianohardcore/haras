...
<c:url var="deleteUrl" value="/cliente/cliente-endereco/"  />
<c:url var="deleteUrlAnimal" value="/cliente/cliente-animal/"  />
<c:url var="contador" value="0" />
<c:url var="urlCliente" value="/cliente" />
<c:url var="urlEndereco" value="/cliente_endereco" />

<script type='text/javascript'
	src='<c:url value="/resources/jqgrid/js/jquery-1.9.0.min.js"/>'>
</script>
...
$(document).on('click', 'a.removeAnimal', function(){
	var id = $(this.parentNode.parentNode).attr('data-id');	
	var linha = $(this);	
	if (id != null){
		$.ajax({
